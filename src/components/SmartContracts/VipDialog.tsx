    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-lg p-4">
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xl font-bold text-amber-400">300 USDT</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className={`font-bold ${userBalance >= 300 ? 'text-green-400' : 'text-red-400'}`}>
          ...
          {userBalance < 300 && (
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
              <p className="text-red-400 text-sm flex items-start gap-2">
                ...
                <span>Недостаточно средств. Пополните баланс на {(300 - userBalance).toFixed(2)} USDT</span>
              </p>
            </div>
          )}
          ...
          <Button
            onClick={onPurchase}
            disabled={isPurchasing || userBalance < 300}
          ...
          >
            {isPurchasing ? 'Обработка...' : 'Купить VIP за 300 USDT'}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
