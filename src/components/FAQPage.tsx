...
const FAQPage = () => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Пополнение баланса — без комиссии. Вывод средств — комиссия сети (зависит от блокчейна). Покупка плагинов — без дополнительных комиссий. Участие в лотерее — фиксированная цена билета.'
    },
    {
      id: 6,
      category: 'Лотерея',
      question: 'Как работает лотерея?',
      answer: 'В каждом розыгрыше доступно 10 билетов по 50 USDT каждый. Когда все билеты проданы, через 1 минуту случайным образом определяется победитель, который получает 400 USDT на свой баланс.'
    },
    {
      id: 7,
      category: 'Лотерея',
      question: 'Можно ли купить несколько билетов?',
      answer: 'Да, один пользователь может купить любое количество билетов в одном розыгрыше. Чем больше билетов у вас, тем выше шанс на победу.'
    },
    {
      id: 8,
      category: 'Лотерея',
      question: 'Как узнать результаты лотереи?',
      answer: 'Результаты отображаются на странице лотереи сразу после розыгрыша. Все участники получают уведомления с информацией о победителе. История всех розыгрышей доступна на странице лотереи.'
    },
    {
      id: 9,
      category: 'Плагины',
      question: 'Что такое плагины?',
      answer: 'Плагины — это инструменты для работы с криптовалютой: Flash USDT, генераторы кошельков, инструменты для майнинга, боты для трейдинга и другие полезные утилиты для криптоэнтузиастов.'
    },
    {
      id: 10,
      category: 'Плагины',
      question: 'Как купить плагин?',
      answer: 'Выберите нужный плагин, нажмите "Купить" и подтвердите покупку. Средства спишутся с вашего баланса. После покупки плагин станет доступен в разделе "Мои покупки" в личном кабинете.'
    },
    {
      id: 11,
      category: 'Плагины',
      question: 'Можно ли вернуть деньги за плагин?',
      answer: 'Возврат средств возможен в течение 24 часов с момента покупки, если плагин не был активирован или скачан. Обратитесь в поддержку с указанием причины возврата.'
    },
    {
      id: 12,
