  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer: 'Git Crypto — это многофункциональная криптовалютная платформа. Здесь вы можете покупать и продавать криптовалюту, общаться на форуме, пользоваться реферальной программой, создавать гарантийные сделки и получать профессиональную поддержку.'
    },
    {
      id: 2,
      category: 'Общие вопросы',
