...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden">
      <ShaderBackground />
      <div className="relative z-10 w-full max-w-6xl px-4 grid lg:grid-cols-2 gap-8 items-center overflow-y-auto lg:overflow-visible max-h-screen lg:max-h-none">
